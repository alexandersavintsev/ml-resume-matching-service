...
Баланс после запроса не изменился.
...
В GET /history/transactions есть запись "amount_credits": 20, а в сценарии B2 показано только top-up на 50. Причина: просто пополнил баланс дополнительно.
...
Тестирование выполнялось вручную через Swagger UI.
